...
void error_443(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 443 " + client + std::string(" ") + channel + " :is already on channel" + "\n";
...
void error_441(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 441 " + client + std::string(" ") + channel + " :They aren't on that channel" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_476(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 476 " + client + std::string(" ") + channel + " :Bad Channel Mask" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_403(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 403 " + client + std::string(" ") + channel + " :No such channel" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_442(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 442 " + client + std::string(" ") + channel + " :You're not on that channel" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_461(int fd, std::string client, std::string command)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 461 " + client + command + " :Not enough parameters" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_482(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 482 " + client + std::string(" ") + channel + " :You're not channel operator" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_501(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 501 " + client + " :Unknown MODE flag" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_431(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 431 " + client + " :No nickname given" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_432(int fd, std::string client, std::string target_nick)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 432 " + client + target_nick + ":Erroneus nickname" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_433(int fd, std::string client, std::string target_nick)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 433 " + client + target_nick + ":Nickname is already in use" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_436(int fd, std::string client, std::string target_nick)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 436 " + client + target_nick + ":Nickname collision KILL from <user>@<host>" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_401(int fd, std::string client, std::string target_nick)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 401 " + client + target_nick + " :No such nick/channel" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_402(int fd, std::string client, std::string target_server)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 402 " + client + target_server + " :No such server" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_404(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 404 " + client + std::string(" ") + channel + " :Cannot send to channel" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_411(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 411 " + client + " :No recipient given (<command>)" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_412(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 412 " + client + " :No text to send" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_462(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 462 " + client + " :You may not reregister" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_405(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 405 " + client + std::string(" ") + channel + " :You have joined too many channels" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_406(int fd, std::string client, std::string target_nick)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 406 " + client + target_nick + " :There was no such nickname" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_409(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 409 " + client + " :No origin specified" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_417(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 417 " + client + " :Input line was too long" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_421(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 421 " + client + " <command> :Unknown command" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_451(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 451 " + client + " :You have not registered" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_464(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 464 " + client + " :Password incorrect" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_465(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 465 " + client + " :You are banned from this server." + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_471(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 471 " + client + std::string(" ") + channel + " :Cannot join channel (+l)" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_472(int fd, std::string client, std::string mode_char)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 472 " + client +  mode_char + " :is unknown mode char to me" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_473(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 473 " + client + std::string(" ") + channel + " :Cannot join channel (+i)" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_474(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 474 " + client + std::string(" ") + channel + " :Cannot join channel (+b)" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_475(int fd, std::string client, std::string channel)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 475 " + client + std::string(" ") + channel + " :Cannot join channel (+k)" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_483(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 483 " + client + " :You cant kill a server!" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
...
void error_491(int fd, std::string client)
{
	...
	std::string errorMsg = std::string(":") + SERVER_NAME + " 491 " + client + " :No O-lines for your host" + "\n";
	send(fd, errorMsg.c_str(), errorMsg.size(), 0);
